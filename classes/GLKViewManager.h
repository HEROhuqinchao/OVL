...
@class OVLScript;
@interface GLKViewManager : GLKView
<AVCaptureVideoDataOutputSampleBufferDelegate, AVCaptureAudioDataOutputSampleBufferDelegate>
-(void) loadScript:(OVLScript*_Nonnull)script;
-(void) switchScript:(OVLScript*_Nonnull)script;
@property (nullable, nonatomic, weak) id<GLKViewManagerDelegate> myDelegate;
 ...
 *.*/
@property (nonatomic, strong, nullable) UIImage *warterMark;
 ...
 */
@property (nonatomic, readonly) NSURL * _Nullable  saveLocalVideoPath;
 ...
 */
- (instancetype _Nullable )initWithFrame:(CGRect)frame context:(EAGLContext *)context configuration:(ADYLiveVideoConfiguration *_Nullable)configuration;
